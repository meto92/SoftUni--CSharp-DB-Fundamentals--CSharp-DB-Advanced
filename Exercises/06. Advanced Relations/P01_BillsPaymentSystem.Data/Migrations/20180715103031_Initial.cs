        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                @"ALTER TABLE PaymentMethods
                  ADD CONSTRAINT UQ_PaymentMethods_UserId_BankAccountId_CreditCardId
                  UNIQUE(UserId, BankAccountId, CreditCardId)");

            migrationBuilder.Sql(
                @"ALTER TABLE PaymentMethods
                  ADD CONSTRAINT CHK_PaymentMethods_Ids
                  CHECK(BankAccountId IS NULL AND CreditCardId IS NOT NULL 
                        OR BankAccountId IS NOT NULL AND CreditCardId IS NULL)");

            migrationBuilder.Sql(
                @"ALTER TABLE PaymentMethods
                  ADD CONSTRAINT CHK_PaymentMethods_Type
                  CHECK(Type IN ('BankAccount', 'CreditCard'))");
        }
